...
def editarPaciente():
    ...
    try:
        ...
        if not id_paciente or not nombre or not apellido_paterno or not apellido_materno or not fecha_nac:
        ...
        resultado = execute_query(
            ...
            (id_paciente,nombre, apellido_paterno, apellido_materno, fecha_nacimiento, alergias, enfermedadesCronicas, antecedentesFamiliares),
